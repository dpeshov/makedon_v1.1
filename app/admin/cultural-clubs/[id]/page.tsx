...
async function setApproval(id: string, next: "approved" | "rejected") {
  ...
  revalidatePath(`/admin/cultural-clubs/${id}`);
...
export default async function AdminCulturalClubDetailPage({ params }: { params: { id: string } }) {
  ...
  if (!row) {
    return (
      <Surface className="p-7 sm:p-10">
        ...
        <div className="mt-6">
          <ButtonLink href="/admin/cultural-clubs" variant="secondary">
            Back
          </ButtonLink>
        </div>
      </Surface>
  ...
  return (
    <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div className="min-w-0">
            ...
            <p className="mt-2 text-sm text-slate-600">
              Back to{" "}
              <Link className="font-semibold underline underline-offset-4" href="/admin/cultural-clubs">
                cultural clubs
              </Link>
              .
            </p>
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        ...
        <Field label="Focus areas" value={row.focus_areas} />
        <Field label="Activities" value={row.activities} />
